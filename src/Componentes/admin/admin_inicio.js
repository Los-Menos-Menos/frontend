                ...
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <div class="d-flex p-3">
                            ...
                            </div><button class="btn btn-primary justify-self-end align-self-end" type="button" onClick={() => this.props.cambiarPagina("AdminUsuarios")}>Ir</button>
                        </div>
                    </div>
                    <div class="col d-flex justify-content-center">
                        <div class="d-flex p-3">
                            ...
                            </div><button class="btn btn-primary" type="button" onClick={() => this.props.cambiarPagina("AdminReservas")}>Ir</button>
                        </div>
                    </div>
                </div>
